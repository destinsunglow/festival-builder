import {
	EventDispatcher, // Changed from Controls
	Quaternion,
	Vector3
} from 'three';
...
class FlyControls extends EventDispatcher { // Changed from Controls

	constructor( object, domElement = null ) {
    super(); // Call EventDispatcher constructor - MOVED HERE

		// super( object, domElement ); // Removed super call for EventDispatcher

		// Assign object and domElement manually if needed by the class logic
		this.object = object;
		this.domElement = domElement;

		// Add enabled property if it's used (EventDispatcher doesn't have it by default)
		this.enabled = true;


		this.movementSpeed = 1.0;
		this.rollSpeed = 0; // Disable roll
